...
#### Marcação dos pontos de interrupção no código `SingletonLazyDebug.java`:
...
#### Inspeção do painel Variables. O atributo estático `instancia` possui valor inicial `null`
